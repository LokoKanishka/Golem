...
payload = {
    ...
    "gateway_context": summary_value("gateway_context"),
    "gateway_last_signal": summary_value("gateway_last_signal"),
    "suggested_first_action": summary_value("suggested_first_action"),
    "second_action": summary_value("second_action"),
