...
printf 'TASK_HOST_LOOP_NOTE: this verify covers only the declarative task<->host expectation, evaluation, read-side, and refresh loop across canonical host sources\n'
